...
'404' => array(
  'Not Found', 
  'We couldn\'t find <u>THEREQUESTURI</u>'.
  ' on our server, though it\'s most certainly not '.
  'your fault.'),
'405' => array(
  'Method Not Allowed', 
...
function aa_print_html ($AA_C){
    global $AA_REQUEST_METHOD, $AA_REASON_PHRASE, $AA_MESSAGE, $new_pagetitle, $box, $_SITE;
    ...
    if($AA_C == '400'||$AA_C == '403'||$AA_C == '405'||$AA_C[0] == '5'){
        ...
        $title = "$AA_C $AA_REASON_PHRASE";
        $box['title'] = "$AA_REASON_PHRASE";
		$box['content'] = "<p>$AA_MESSAGE<br><a href=\"$_SITE[homepage_url]\">Click here to go to our homepage</a>\n</p>\n";
        return true;
    } else return false;
}
...
// header
include_once(DIR_BOXES . 'header.php');
include(DIR_BOXES . 'box.content.php');
include_once(DIR_BOXES . 'footer.php');
